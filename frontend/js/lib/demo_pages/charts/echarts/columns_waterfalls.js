    ...
    var _columnsWaterfallsExamples = function() {
        ...
        if (columns_basic_element) {
            ...
            columns_basic.setOption({
                ...
                // Define colors
                color: ['#2ec7c9','#b6a2de','#5ab1ef','#ffb980','#d87a80','#2e932c','#ae2508'],
        ...
        //         // Add legend
        //         legend: {
        //             data: ['لبنیات', 'مواد غذایی', 'شوینده', 'بهداشتی', 'ورزشی', 'غذا', 'سایر'],//, 'Google', 'Bing'],
        //             itemHeight: 8,
        //             itemGap: 20
        //         },
        //
        ...
        //         xAxis: [{
        //             type: 'category',
        //             data: ['شنبه', 'یکشنبه', 'دوشنبه', 'سه شنبه', 'چهار شنبه', 'پنجشنبه', 'جمعه'],
        //             axisLabel: {
        //                 color: '#333'
        //             },
        //             axisLine: {
