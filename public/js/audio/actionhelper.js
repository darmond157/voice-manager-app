...
function mergeTrack() {
	...
	if(audioList.length >= 2){
		document.getElementById('merged-track-div').classList.remove('d-none')
		document.getElementById('merged-track-div').classList.add('d-flex')
		document.getElementById('merged-track-div').classList.add('flex-column')
		document.getElementById('select_voice').innerHTML = document.getElementById('select_voice').innerHTML +  `<option value="2">نسخه ویرایش شده</option>`
